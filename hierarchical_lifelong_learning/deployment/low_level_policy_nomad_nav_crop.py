...
class LowLevelPolicy(Node): 
    ...
    def timer_callback(self):
        ...
        if len(self.context_queue) > self.model_params["context_size"]:
            ...
            self.goal_image = PILImage.open(f"goal_crop.png")
            self.goal_image = transform_images([self.goal_image], self.model_params["image_size"], center_crop=False)
