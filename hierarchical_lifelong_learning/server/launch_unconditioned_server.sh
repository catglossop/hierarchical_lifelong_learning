...
tmux send-keys "cd /nfs/nfs2/users/cglossop/hierarchical_lifelong_learning/hierarchical_lifelong_learning/server && python vlm_closed_cloop_server.py" Enter
